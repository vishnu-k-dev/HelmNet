/*
 * SmartHelm — CAM3 Firmware (Rear traffic)
 ...
 *
 * Stream URL: http://<CAM3_IP>/stream
 * Static IP:  Assign 192.168.1.103 via router DHCP reservation (use MAC from Serial Monitor)
 *
