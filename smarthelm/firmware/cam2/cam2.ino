/*
 * SmartHelm — CAM2 Firmware (Road-facing, front)
 ...
 *
 * Stream URL: http://<CAM2_IP>/stream
 * Static IP:  Assign 192.168.1.102 via router DHCP reservation (use MAC from Serial Monitor)
 *
